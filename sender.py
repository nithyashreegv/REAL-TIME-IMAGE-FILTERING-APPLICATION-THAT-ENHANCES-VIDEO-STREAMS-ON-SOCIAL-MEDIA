...
class Sender:
    def __init__(self, root, receiver_ip="192.168.46.10", send_port=5000, recv_port=5001):
        self.root = root
        self.root.title("Video Call - Sender")
    ...
    def send_video(self):
        while self.running:
            ...
            self.send_sock.sendto(data, (self.receiver_ip, self.send_port))
